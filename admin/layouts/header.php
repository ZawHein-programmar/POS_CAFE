                ...
                <div class="header-right">
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <a href="javascript:void(0)" id="theme-switcher" class="log-user">
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-notebook menu-icon"></i><span class="nav-text">Cafe Management</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./main_categories.php">Main Categories</a></li>
                            <li><a href="./second_categories.php">Second Categories</a></li>
